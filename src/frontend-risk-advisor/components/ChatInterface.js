function ChatInterface() {
  const [messages, setMessages] = React.useState([
  {
    id: 1,
    type: 'ai',
    content: "Hello! I'm your Risk Advisor AI. I can help you with risk analysis, mitigation strategies, and scenario planning. How can I assist you today?",
    timestamp: new Date()
  }]
  );
  ...
  const generateAIResponse = (userMessage) => {
    ...
    if (message.includes('risk score') || message.includes('analyze')) {
      return {
        id: Date.now(),
        type: 'ai',
        content: "I've analyzed your current risk landscape. Here's what I found:",
        timestamp: new Date(),
      ...
      return {
        id: Date.now(),
        type: 'ai',
        content: "Here are the recommended mitigation strategies based on your risk profile:",
        timestamp: new Date(),
      ...
      return {
        id: Date.now(),
        type: 'ai',
        content: "I've detected some critical risk alerts that need your attention:",
        timestamp: new Date(),
        component: 'AlertDemo'
      };
      ...
      return {
        id: Date.now(),
        type: 'ai',
        content: "Hello! I'm here to help with your risk management needs. I can provide risk analysis, mitigation strategies, scenario planning, and real-time alerts. What would you like to explore?",
        timestamp: new Date()
      };
    } else {
      return {
        id: Date.now(),
        type: 'ai',
        content: "I understand you're looking for risk management assistance. I can help with:\n\n• Risk score analysis and prioritization\n• Mitigation strategy recommendations\n• Scenario-based guidance\n• Real-time risk alerts\n\nWhat specific area would you like to focus on?",
        timestamp: new Date()
      };
    }
  };
