...
export function RiskAdviceReportData() {
  ...
  return (
    <>
      ...
      <div
      className={`fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity ${open ? "opacity-100 visible" : "opacity-0 invisible"}`}
    >
      <div className="bg-white p-6 rounded-lg w-3/4">
        <button onClick={close} className="absolute top-4 right-4 text-gray-500 hover:text-gray-700">✖</button>
        ...
        <div>
          <div className="flex space-x-4 border-b pb-2">
            <button className="px-4 py-2 bg-blue-500 text-white rounded">Details</button>
            <button className="px-4 py-2 bg-gray-200 rounded">Mitigation</button>
          ...
          <div className="grid grid-cols-2 gap-4 pt-5">
            <div>
              <div className="flex items-center space-x-4">
                <p>Risk ID:</p>
                <input type="text" value={riskID} onChange={(e) => setRiskID(e.target.value)} className="border p-2 w-full" />
              </div>
              <div className="flex items-center space-x-4 mt-4">
                <p>Risk Name:</p>
                <input type="text" value={riskName} onChange={(e) => setRiskName(e.target.value)} className="border p-2 w-full" />
              </div>
              <div className="flex items-center space-x-4 mt-4">
                <p>Department Name:</p>
                <select value={deptmentName} onChange={(e) => setdeptmentName(e.target.value)} className="border p-2 w-full">
                  <option>hi</option>
                </select>
              </div>
              <div className="flex items-center space-x-4 mt-4">
                <p>Probability Levels:</p>
                <input type="text" value={riskProbabilityLevel} onChange={(e) => setRiskProbabilityLevel(e.target.value)} className="border p-2 w-full" />
              </div>
            </div>
            <div>
              <div className="flex items-center space-x-4 mt-4">
