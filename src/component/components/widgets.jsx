  ...
  return (
    <div className="flex items-center gap-4 mt-4">
      <div className="flex flex-row">
        {label && (
          <label
            className={`block min-w-[200px] text-[12.5px] whitespace-nowrap text-[#08376B] ${
              (error ? "text-red-500" : "", disabled ? "text-gray-300" : "")
            }`}>
            {label} {required && <span className="required">*</span>}
          </label>
  ...
  return (
    <div className="flex items-center w-full gap-4 mt-4">
      {label && (
        <label
          htmlFor={id}
          className={`block text-[12.5px] min-w-[200px] whitespace-nowrap text-[#08376B] ${error ? "text-red-500" : ""}`}>
